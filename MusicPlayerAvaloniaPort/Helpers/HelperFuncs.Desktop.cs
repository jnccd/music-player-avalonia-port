...
/// <summary>
/// Desktop only helpers. The platform independent ones (library walking, tag reading, string distances,
/// sigmoid) live in the shared core project (MusicPlayerClientCore) as MusicPlayerAvaloniaPort.Helpers.HelperFuncs;
/// this class only holds what literally cannot run elsewhere (SkiaSharp bitmap tinting and launching local
/// console programs such as yt-dlp). Partial classes cannot span assemblies, which is why this is a second
/// class instead of a second half of HelperFuncs.
/// </summary>
public static class DesktopHelperFuncs
{
